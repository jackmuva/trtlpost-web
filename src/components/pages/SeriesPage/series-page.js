...
const SeriesPage = ({ allSeries }) => {
    ...
    if(allSeries.length === 0) {
        return (
            <div className="flex items-center md:mx-52 sm:mx-2">
        ...
        return (
            <div class = "flex items-center md:mx-52 sm:mx-2">
                <div class = "flex flex-col my-3 space-y-4 md:mx-6 sm:mx-0 min-w-full">
                    {arraySeriesItems}
                </div>
            </div>
        );
