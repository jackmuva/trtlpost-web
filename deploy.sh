...
echo "Build Steps:"
echo "building image..."
docker build -t 514832027284.dkr.ecr.us-east-1.amazonaws.com/trtlmail-web:latest .
...
docker push --all-tags 514832027284.dkr.ecr.us-east-1.amazonaws.com/trtlmail-web
